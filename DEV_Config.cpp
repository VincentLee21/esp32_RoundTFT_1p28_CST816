...
// #define __ESP32_3_0_0__

// ------------------------------------------------------------------------------------
// function:  I2C0 R/W functions
// ------------------------------------------------------------------------------------
...
uint8_t DEV_I2C0_Read_Byte(uint8_t addr, uint8_t reg_addr)
{
  uint8_t value;
...
uint8_t DEV_I2C1_Read_Byte(uint8_t addr, uint8_t reg_addr)
{
  uint8_t value;

  Wire1.beginTransmission(addr);
  Wire1.write((byte)reg_addr);
  Wire1.endTransmission();
...
void DEV_GPIO_PWM( int16_t pin, int16_t pwm_channel, int16_t frequency, int16_t resolution) {
  DEV_GPIO_Mode(pin, 1);
  #ifdef __ESP32_3_0_0__
  ledcAttachChannel(pin, frequency, resolution, pwm_channel);
  #else
...
// ------------------------------------------------------------------------------------
// function:  Set GPIO in w/i pullup mode
// ------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------
// function:  Initial GPIO & PWM pins
// ------------------------------------------------------------------------------------
void DEV_GPIO_Init(void)
{
  ...
  DEV_GPIO_PWM_dutycycle( 0, 250); // Dutycycle 250/255
  #else
...
// ------------------------------------------------------------------------------------
// function:  Module Initialize, Initial GPIO & I2C inferface
// ------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------
// function:  Module exits, restore IO settings
// ------------------------------------------------------------------------------------
...
void LEDPWM::Initialize(char *name, uint32_t pin, uint8_t channel,
  ...
  #ifdef __ESP32_3_0_0__
  ledcAttachChannel( _pin, _frequency, _resolution, _channel);
  #else
...
void LEDPWM::SetDutyCycle(uint32_t dutycycle) {
  _dutycycle = dutycycle;
  // Info("%s:ch %d", _name, _channel, _dutycycle);
